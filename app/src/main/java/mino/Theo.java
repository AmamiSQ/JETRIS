...
public class Theo extends Mino{
    ...
    public void setPos(int x, int y) {
        //    0   blocks[1]
        // 0  0  0  blocks[2] blocks[0] blocks[3]
        ...
        blocks[0].y = y;
        blocks[1].y = blocks[2].y = blocks[3].y = y + Block.SIZE;
    ...
    public void getDirection1() {
        ...
        tempB[1].y = tempB[2].y = tempB[3].y = blocks[0].y + Block.SIZE;
    ...
    public void getDirection2() {
        tempB[0].x = tempB[2].x = tempB[3].x = blocks[0].x;
    ...
    public void getDirection3() {
        tempB[0].y = tempB[3].y = tempB[2].y = blocks[0].y;
